...
export async function openDeviceTreeOutputSocument(): Promise<string> {
  ...
  const message = `/* This content was auto generated by the dts-lsp language server.
  This content is not to be considered the same as what the dts compile would out put and 
  should be used as an referance of how the final output may look like*/.
${dts}
`;
  return message;
}
