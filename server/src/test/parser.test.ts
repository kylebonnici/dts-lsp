...
describe('Parser', () => {
	...
	describe('Memreserve', () => {
		...
		test('Missing start and end address slash', async () => {
			...
			expect(
				parser.issues[1].raw.astElement.lastToken.pos.colEnd,
			).toEqual(12);
	...
	describe('Missing close curly', () => {
		...
		test('Child Node', async () => {
			...
			expect(parser.issues[1].raw.astElement.lastToken.pos.col).toEqual(
				16,
			);
			expect(parser.issues[1].raw.astElement.lastToken.pos.len).toEqual(
				1,
			);
		});
	...
	describe('White Space', () => {
		test('Child node, whitespace between address', async () => {
			...
			expect(
				parser.issues[0].raw.astElement.firstToken.pos.colEnd,
			).toEqual(8);
			expect(parser.issues[0].raw.astElement.lastToken.pos.col).toEqual(
				9,
			);
		...
		describe('Values', () => {
			...
			describe('Bytestring value', () => {
				...
				test('With no odd values no spaces ', async () => {
					...
					expect(
						parser.issues[0].raw.astElement.lastToken.pos.col,
					).toEqual(14);
					expect(
						parser.issues[0].raw.astElement.lastToken.pos.len,
					).toEqual(1);
			...
			describe('Cell array', () => {
				...
				describe('Node Ref Path', () => {
					...
					test('missing ending curly', async () => {
						...
						expect(
							parser.issues[0].raw.astElement.lastToken.pos
								.colEnd,
						).toEqual(22);
					});
				});
			...
			describe('Multiple values', () => {
				...
				test('Missing value', async () => {
					...
					expect(
						parser.issues[0].raw.astElement.firstToken.pos.col,
					).toEqual(14);
					expect(
						parser.issues[0].raw.astElement.lastToken.pos.col,
					).toEqual(16);
